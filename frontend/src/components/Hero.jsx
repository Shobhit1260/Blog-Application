      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <motion.div
            ...
            className="inline-block px-4 py-1.5 mb-6 bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-indigo-900/30 dark:to-cyan-900/30 rounded-full"
          >
          ...
          >
            Write, read and <span className="font-display bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent">share knowledge</span>
          </motion.h1>
          ...
          >
            <Link 
              to="/create" 
              className="group px-6 py-3.5 bg-gradient-to-r from-teal-600 to-cyan-400 text-white rounded-lg shadow-lg hover:shadow-xl font-semibold text-lg flex items-center gap-2"
            >
          ...
          >
            <div>
              <div className="text-3xl font-bold bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent">10K+</div>
              <div className="text-sm text-gray-600 dark:text-gray-400 font-medium">Stories</div>
            </div>
            <div>
              <div className="text-3xl font-bold bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent">5K+</div>
              <div className="text-sm text-gray-600 dark:text-gray-400 font-medium">Writers</div>
            </div>
            <div>
              <div className="text-3xl font-bold bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent">50K+</div>
